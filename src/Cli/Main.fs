...
module Main =
    ...
    let run input args =
        ...
        | { Year = 2024; Day = 3; Part = 1 } -> Year2024.Day03.part1 input |> printfn "%A"
        | { Year = 2024; Day = 3; Part = 2 } -> Year2024.Day03.part2 input |> printfn "%A"
        | { Year = 2024; Day = 4; Part = 1 } -> Year2024.Day04.part1 input |> printfn "%A"
        | { Year = 2024; Day = 4; Part = 2 } -> Year2024.Day04.part2 input |> printfn "%A"
        | { Year = 2025; Day = 1; Part = 1 } -> Year2025.Day01.part1 input |> printfn "%A"
        | { Year = 2025; Day = 1; Part = 2 } -> Year2025.Day01.part2 input |> printfn "%A"
        | { Year = 2025; Day = 2; Part = 1 } -> Year2025.Day02.part1 input |> printfn "%A"
        | { Year = 2025; Day = 2; Part = 2 } -> Year2025.Day02.part2 input |> printfn "%A"
        | { Year = 2025; Day = 3; Part = 1 } -> Year2025.Day03.part1 input |> printfn "%A"
        | { Year = 2025; Day = 3; Part = 2 } -> Year2025.Day03.part2 input |> printfn "%A"
        | { Year = 2025; Day = 4; Part = 1 } -> Year2025.Day04.part1 input |> printfn "%A"
        | { Year = 2025; Day = 4; Part = 2 } -> Year2025.Day04.part2 input |> printfn "%A"
        | { Year = 2025; Day = 5; Part = 1 } -> Year2025.Day05.part1 input |> printfn "%A"
        ...
        | { Year = 2025; Day = 8; Part = 1 } -> Year2025.Day08.part1 1000 input |> printfn "%A"
        | { Year = 2025; Day = 8; Part = 2 } -> Year2025.Day08.part2 input |> printfn "%A"
